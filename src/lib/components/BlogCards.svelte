		...
		<div class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-4">
			...
			<div class="bg-primary border rounded-lg p-4 shadow-md hover:shadow-lg text-primary-content">
				...
				<div class="flex items-center justify-between mt-4">
					...
					<div class="flex items-center">
						<a href={`/${blog.slug}`} class="block font-bold hover:cursor-pointer hover:underline hover:text-warning">Read more</a>
					</div>
					<div class="flex items-center">
						<ul class="flex justify-end mt-4">
							<li class="inline pr-2">
								...
								<i class="fa fa-envelope-o fa-lg  hover:text-warning" on:click={() => shareButtonClick(blog)}></i>
							</li>
							<li class="inline">
								<!-- svelte-ignore a11y-click-events-have-key-events -->
								<!-- svelte-ignore a11y-no-static-element-interactions -->
